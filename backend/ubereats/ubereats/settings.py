...
SECRET_KEY = 'django-insecure-!%whfaun2bid-rntaw*be2jgk7(us)x#@223)u0bz@-d)bc=kr'
...
ASGI_APPLICATION = 'ubereats.asgi.application'
...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': os.getenv('DJANGO_DB_NAME','ubereats'),
        'CLIENT': {
