...
import { loginCustomer, selectAuthLoading, selectAuthError } from '../../slices/authSlice';
...
const CustomerLogin = () => {
   ...
   return (
       <div style={{ fontFamily: '"-apple-system", "San Francisco", "System UI", sans-serif' }}>
...
//        setLoading(true);
//        try {
//            const response = await axios.post(`${baseUrl}/api/customers/login/`, credentials);
